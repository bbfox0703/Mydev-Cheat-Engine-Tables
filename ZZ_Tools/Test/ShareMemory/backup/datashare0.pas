...
begin
  OpenSharedMemory;
  //SharedMemoryMgr := TSharedMemoryManager.Create(65536, 'MySharedMemory', 'MySharedMemoryState');
end;

procedure TMainForm.FormDestroy(Sender: TObject);
begin
   CloseSharedMemory;
   //FreeAndNil(SharedMemoryMgr);
end;
